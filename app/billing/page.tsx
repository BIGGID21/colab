...
// Moved to top to ensure availability throughout the file
...
export default function BillingPage() {
  ...
  const handleUpgrade = async () => {
    ...
    try {
      // UPDATED: Using the ₦5,000 Naira one-time payment logic
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-black transition-colors duration-300 pb-24">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-12 md:pt-20 text-center">
        ...
        <p className="text-zinc-500 dark:text-zinc-400 text-base md:text-lg mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto text-left">
          ...
          <div className="bg-white dark:bg-[#0a0a0a] rounded-[2rem] p-8 border-2 border-[#9cf822] shadow-[0_0_40px_-15px_rgba(156,248,34,0.3)] flex flex-col relative transform md:-translate-y-4">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 bg-[#9cf822] text-black text-[10px] font-black px-4 py-1 rounded-b-xl uppercase tracking-widest">
              Most Popular
            </div>
            ...
            <div className="mb-8">
              ...
              <span className="text-zinc-500 font-medium ml-1">/one-time</span>
              <p className="text-[10px] text-zinc-400 mt-1 uppercase tracking-wider font-bold">Lifetime Access</p>
            </div>
            <ul className="space-y-4 mb-8 flex-grow">
            ...
            <button 
              ...
              className="w-full py-3.5 bg-[#9cf822] text-black font-black rounded-xl shadow-lg shadow-[#9cf822]/20 hover:scale-[1.02] transition-transform flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
            >
          ...
          <div className="bg-white dark:bg-[#0a0a0a] rounded-[2rem] p-8 border border-zinc-200 dark:border-zinc-800 flex flex-col">
            ...
            <div className="mb-8 font-black text-4xl">₦50,000<span className="text-zinc-500 text-sm font-medium">/mo</span></div>
            <ul className="space-y-4 mb-8 flex-grow">
