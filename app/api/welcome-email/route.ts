...
export async function POST(request: Request) {
  try {
    ...
    const data = await resend.emails.send({
      from: 'CoLab <onboarding@resend.dev>', // Update this when you add your custom domain to Resend
      to: email,
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #ffffff; max-width: 600px; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
                  ...
                  <tr>
                    <td style="padding: 40px 30px;">
                      ...
                      <a href="https://colab-nine.vercel.app/community" style="display: inline-block; background-color: #9cf822; color: #000000; text-decoration: none; font-size: 14px; font-weight: 800; padding: 16px 32px; border-radius: 12px;">Go to Dashboard</a>
                    </td>
                  </tr>
                </table>
              </td>
