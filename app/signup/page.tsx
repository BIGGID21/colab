...
import { Loader2, Mail, Lock, User, ArrowRight, CheckCircle2, Sparkles, Eye, EyeOff } from 'lucide-react';
        ...
        <div className="w-full max-w-[420px] mt-12 lg:mt-0">
          <div className="text-center lg:text-left mb-10">
            ...
            <div className="flex items-center justify-center lg:justify-start gap-4">
               ...
               <p className="text-zinc-500 dark:text-zinc-400 text-sm">Sign up with your email</p>
          ...
          {success ? (
            <div className="bg-green-50 dark:bg-green-500/10 border border-green-200 dark:border-green-500/20 rounded-2xl p-6 text-center animate-in zoom-in duration-300">
              ...
              <p className="text-green-600 dark:text-green-500/80 text-sm">
                We sent a verification link to <span className="font-bold">{email}</span>. Click the link to activate your account.
              </p>
              <button 
