          ...
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <button 
                ...
                className="w-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-800 text-black dark:text-white font-bold py-4 rounded-[22px] transition-all flex items-center justify-center gap-3"
              >
